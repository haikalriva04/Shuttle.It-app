    ...
    <ScrollView className="flex-1 bg-white">
      ...
      <View className="p-5">
        ...
        onChangeText={(value) => setForm({
          ...
          <CustomButton title="Sign Up" onPress={onSignUpPress} className="mt-16"/>

          <OAuth />
     

          <Link href="/sign-in" className="text-lg text-center text-general-200 mt-20">
          ...
          <ReactNativeModal isVisible={showSuccessModal} >
            <View className="bg-white px-7 py-9 rounded-2xl min-h-[300px]">
              ...
              <Text className="text-3xl font-PoppinsBold text-center">Verified</Text>
              <Text className="text-base text-gray-400 font-PoppinsRegular text-center mt-3">
                Akun berhasil terverifikasi
              </Text>

              <CustomButton 
              title="Masuk Homepage"
