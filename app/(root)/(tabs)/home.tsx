import CampusScheduleButton from "@/components/CampusScheduleButton"; // [ADDED] Import the new component
...
// [ADDED] Data for the campus buttons
const campusButtons = [
    { id: '1', title: 'Binus @ Alam Sutera', image: images.binusAlamSutera },
    { id: '2', title: 'Binus @ Kemanggisan', image: images.binusKemanggisan }, // Check if this key matches your constants
    { id: '3', title: 'Binus @ Senayan', image: images.binusSenayan },
    { id: '4', title: 'Binus @ Bandung Paskal', image: images.binusPaskal || images.binusAlamSutera }, // Fallback if image missing
    { id: '5', title: 'Binus @ Bandung Dago', image: images.binusDago || images.binusAlamSutera },     // Fallback if image missing
];
            ...
            <SafeAreaView className="bg-transparent" edges={['left', 'right', 'bottom']}>
                <ScrollView className="px-5" contentContainerStyle={{ paddingBottom: 100 }}>
                    ...
                    <>
                        ...
                        <View className="flex flex-row items-center bg-transparent h-[300px] rounded-xl overflow-hidden">
                            <Map />
                        </View>
                    </>

                    {/* [ADDED] Campus Schedule Section */}
                    <View className="mt-5">
                        <Text className="text-lg font-PoppinsBold text-white mb-3">
                            Jadwal Bus Setiap Kampus
                        </Text>
                        ...
                        <FlatList 
                            ...
                            renderItem={({ item }) => (
                                <CampusScheduleButton 
                                    ...
                                    image={item.image}
                                    onPress={() => {
                                        // Handle button press here (e.g., navigate to schedule detail)
